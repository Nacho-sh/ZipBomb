//El video en el que aprendi esto fue https://youtu.be/Pmak4HY586o


import java.awt.Image;
public class Main extends javax.swing.JFrame {
	
	private static final long serialVersionUID = -2445361976639360671L;
	public Main() {
        initComponents();
        Image icon = ResourceLoader.getImage("bomb.png");
        setIconImage(icon);
    }
    ...
    private void jPasswordField1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(validate.isPasswordCorrect(input)){
           try {
			Unzip.main();
		} catch (Exception e) {
			e.printStackTrace();
